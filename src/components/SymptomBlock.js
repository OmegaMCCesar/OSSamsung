...
const SymptomBlock = ({ selectedBlock, onSymptomSelect }) => {
  const symptomBlocks = {
    ...
    '5B01-ASSY-DOOR':[{simtom:'SRC002-AJUSTE/ALINEACION/CONFIGURACION ', description:'En caso de ser necesario realizar el desmonte de puertas, vamos a ocupar los siguientes codigos de cierre. Este servico tiene un costo extra. No esta incluido en la instalacion.'},{simtom:'SRC013-PROBLEMAS DE OPERACION(DOOR)',description:'Una puerta que no cierra de manera correcta nos detendra el funcionamiento de la lavadora'}],
    '5B01-ASSY-DOOR ':[{simtom:'SRC013-PROBLEMAS DE OPERACION(DOOR)',description:'Una puerta que no cierra de manera correcta nos dara un mal funcionamineto del refrigerador'},{simtom:'SRC002-AJUSTE/ALINEACION/CONFIGURACION ', description:'En caso de ser necesario realizar el desmonte de puertas, vamos a ocupar los siguientes codigos de cierre. Este servico tiene un costo extra. No esta incluido en la instalacion.'}],
