...
const SymptomBlock = ({ selectedBlock, onSymptomSelect }) => {
  const symptomBlocks = {
    ...
    'select(TOP-COVER)':[{simtom:'SRC012-PROBLEMAS DE ENCENDIDO ',description:'Una ves que se confirmo voltaje adecuado entrante a display y este no enciende sera necesario cambiar la pieza'},{simtom:'SRC013-PROBLEMAS DE OPERACION',description:'Cuando encontramos daño en los botones, no digita o se puede controlar de manera correcta el equipo, es posible que este dañado el panel'}],
    ...
    '5D01-PUMP MOTOR':[{simtom:'SRC013-PROBLEMAS DE OPERACION  ',description:'Si la bomba de drenado no funciona y no desecha el agua de la tina provocara que la lavadora no centrifuge, asi que presentara problemas de rotacion'},{simtom:' SRC015-RUIDO ',description:'Si la bomba de drenado presenta un ruido anomalo, es posible que la bomba este dañada o atorada con algun objeto'}],
    ...
    '4C09-EVAPORATOR COVER':[{simtom:' SRC021-CALENTAMIENTO/REFRIGERACION', description: 'Cuan tenemos un enfriamiento pobre usamos estos codigos de cierre , ya que si existe frio, pero no es el adecuado, es posible que la pieza este dañada o mal colocada'}],
    '4C11-BIMETAL':[{simtom:'SRC021-CALENTAMIENTO/REFRIGERACION(bimetal)',description:'Cuando la resistencia de deshielo esta en buenas condiciones, pero aun asi no hace deshielo , es muy probavle que el vimetal este en mal estado'}],
    ...
    '4B05-CONDENSER':[{simtom:'SRC021-CALENTAMIENTO/REFRIGERACION(CONDENSER)',description:'Si el condensador se encuentra sin servicio, demasiado lleno de suciedad, pelusa o algun material que impida el correcto flujo de aire para la extraccion de calor, nos dara un enfriamientio tenue'},{simtom:'SRC022-FUGA/FUGA',description:'Cualquier perdida de gas es considerada fuga de refrigerante, en este caso es en latuberia de condensador'},{simtom:'SRC003-LIMPIEZA', description:'Se utilizan estos codigos para el cierre de una OS en la cual se realizo mantenimiento'}],
    '4C05-EVAPORATOR':[{simtom:'SRC022-FUGA/FUGA',description:'Cualquier perdida de gas por desgaste del condensador es considerada fuga de gas'},{simtom:'SRC008-OTROS PROBLEMAS',description:'Cierres para un evaporador que no tiene rastros de frio o congelacion'},{simtom:'SRC003-LIMPIEZA', description:'Se utilizan estos codigos para el cierre de una OS en la cual se realizo mantenimiento'}],
    ...
    'BR07-ICE MAKER':[{simtom:'SRC013-PROBLEMAS DE OPERACION(IM)',description:'Usamos este codigo ya revisamos los demas componentes involucrados para la fabricacion de hielos, y se cambia la ice maker'},{simtom:'  SRC022-FUGA/FUGA  ',description:'Usar este codigo en fuga por exceso de agua'}],
    ...
    '5B01-ASSY-DOOR':[{simtom:'SRC002-AJUSTE/ALINEACION/CONFIGURACION ', description:'En caso de ser necesario realizar el desmonte de puertas, vamos a ocupar los siguientes codigos de cierre. Este servico tiene un costo extra. No esta incluido en la instalacion.'},],
    '5B01-ASSY-DOOR ':[{simtom:'SRC002-AJUSTE/ALINEACION/CONFIGURACION ', description:'En caso de ser necesario realizar el desmonte de puertas, vamos a ocupar los siguientes codigos de cierre. Este servico tiene un costo extra. No esta incluido en la instalacion.'}],
    ...
    '7A04-POWER CORD':[{simtom:SRC012,description:'Si el cordon esta quemado , tiene alguna cortadura o desgaste , puede darnos un mal funcionamiento en el equipo o definitivamente no encender'}],
    ...
    '7D07-WIRE HARNESS ':[{simtom:SRC013A,description:'Daños en el arnes de cables pueden provocar mal funcionamiento del equipo'}],
