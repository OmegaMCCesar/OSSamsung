...
const HL2 = 'HL2-OPERACION INTERMITENTE ';
  ...
  const subSymptoms = {
    ...
    'SRC011-PROBLEMAS COSMETICOS':['HN1-MARCA, ABOLLADURA','HN2-ESPACIO, HUECO','HN3-DEFORMACION','HN4-DECOLORACION','HN6-PARTES SEPARADAS','HN7-PINTURA DESPEGADA','HN8-OXIDADO','HNG-RASGUÑADO'],
