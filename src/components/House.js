...
const House = ({ onSelect }) => {
  ...
  const equipmentOptions = [
    ...
    { name: 'RefrigeradorBespoke', imgURl: 'https://i5-mx.walmartimages.com/samsmx/images/product-images/img_large/981024523l.jpg?odnHeight=612&odnWidth=612&odnBg=FFFFFF', types: ['refrigeradores'], models: ['RF'] },
    { name: 'Laundry', imgURl:'https://vivelaera.com/wp-content/uploads/2024/05/WH22DBH570GV_4.jpg', types: ['laundry'], models:['WH22DBH570GVAX',] },
    { name: 'FrontalWF', imgURl: 'https://www.elpalaciodehierro.com/on/demandware.static/-/Sites-palacio-master-catalog/default/dwf6750753/images/38499949/large/38499949_x1.jpg', types: ['lavadoras'], models: ['WF'] },
    { name: 'LavadoraWT', imgURl: 'https://i5.walmartimages.com/asr/53cda4a7-9c1f-4cfe-b0eb-3c4c9ed49108.6b2874d1ecf3cb150492f8092f90aec8.png?odnHeight=612&odnWidth=612&odnBg=FFFFFF', types: ['lavadoras'], models: ['WT'] },
    { name: 'Lavadora', imgURl: 'https://i5-mx.walmartimages.com/mg/gm/1p/images/product-images/img_large/00880609218772l.jpg?odnHeight=612&odnWidth=612&odnBg=FFFFFF', types: ['lavadoras'], models: ['WA'] },
    { name: 'Estufa', imgURl: 'https://i5-mx.walmartimages.com/samsmx/images/product-images/img_large/981004685l.jpg?odnHeight=612&odnWidth=612&odnBg=FFFFFF', types: ['estufas'], models: ['NX'] },
    { name: 'Lavasecadora', imgURl: 'https://i5-mx.walmartimages.com/samsmx/images/product-images/img_large/981022018l.jpg?odnHeight=612&odnWidth=612&odnBg=FFFFFF', types: ['lavasecadoras'], models: ['WD'] },
  ...
  return (
    <div className={styles.container}>
      <div className={styles.subContainerHead} >
        ...
        <Link to='/' className={styles.buttonHomePage}>Volver a Inicio</Link>
